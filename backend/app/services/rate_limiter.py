...
class RateLimiter:
    ...
    async def check_tool_rate_limit(self, redis_client: Redis, tool_name: str, user_id: str) -> None:
    ...
    async def check_llm_rate_limit(self, redis_client: Redis, provider: str, user_id: str) -> None:

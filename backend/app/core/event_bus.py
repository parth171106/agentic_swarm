...
class EventBus:
    ...
    async def consume(self, stream: str, group: str, consumer: str) -> AsyncGenerator[dict, None]:
        ...
        if self.redis_available:
            try:
                ...
                while True:
                    messages = await self.redis.xreadgroup(group, consumer, {stream: ">"}, count=1, block=1000)

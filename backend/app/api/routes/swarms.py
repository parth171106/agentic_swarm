...
from backend.app.models.swarm_models import CreateSwarmRequest, CreateSwarmResponse, SwarmRunResponse
...
async def create_swarm(request: CreateSwarmRequest, user_id: str = Depends(get_current_user)):
...
async def get_swarm_report(id: str, format: str = "markdown", user_id: str = Depends(get_current_user)):
    raise NotImplementedError()
